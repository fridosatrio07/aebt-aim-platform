...
export const appRoutes: AppRouteDefinition[] = [
  ...
  { id: 'asset-detail', path: '/assets/[assetId]', label: 'Asset 360', pageTitle: 'Asset 360', module: 'Asset Registry', status: 'API-ready', dataStatus: 'Mock', permissionNote: 'Detail route authority remains Needs RBAC Review.', guardrail: 'Detail facts require source evidence and authorized review; no fit-for-operation or final certification decision is produced.', breadcrumb: ['Assets', 'Asset 360'], parentId: 'assets' },
