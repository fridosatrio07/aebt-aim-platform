# R3-06 - Certification Register API
...
Provide certification register API with due/expired filters, evidence readiness, RBAC, and audit logging.
...
- Implement only the behavior required for R3-06 - Certification Register API.
...
* Implementation summary: Added certification register API behavior with status/readiness filters, RBAC checks, tenant scope, audit events, and shared tests.
