# R3-07 - Certification Register UI
...
Create certification register UI for due/expired/upcoming renewal, checklist status, evidence readiness, and review routing.
...
- Implement only the behavior required for R3-07 - Certification Register UI.
...
* Implementation summary: Added certification register UI table showing renewal due dates, readiness, evidence counts, and review-oriented statuses.
