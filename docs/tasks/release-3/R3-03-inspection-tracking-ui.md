...
Create inspection tracking UI with due register, calendar/campaign/workpack view pattern, filters, and action links.
...
- Implement only the behavior required for R3-03 - Inspection Tracking UI.
...
* Implementation summary: Added Release 3 workbench inspection due table, KPI route hints, and workpack drawer links without final compliance labels.
