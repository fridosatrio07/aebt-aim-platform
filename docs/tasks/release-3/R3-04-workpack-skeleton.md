...
Create inspection workpack skeleton with scope, schedule, field execution, findings, evidence, review, and close-out steps.
...
- Implement only the behavior required for R3-04 - Workpack Skeleton.
...
* Implementation summary: Added workpack skeleton schema, shared dataset, API list behavior, UI drawer, workflow steps, draft findings, and evidence references.
