...
Wire first business KPIs to inspection, certification, evidence, risk, anomaly/recommendation placeholders, and action lists.
...
- Implement only the behavior required for R3-10 - Dashboard KPI Wiring.
...
* Implementation summary: Added business KPI card service and UI cards linking dashboard counts to filtered inspection, certification, evidence, and workpack routes.
