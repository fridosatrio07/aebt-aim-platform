# R3-08 - Evidence Checklist Basic
...
Create basic evidence checklist model linked to asset, inspection, certification, RBI, risk, anomaly, recommendation, and compliance export contexts.
...
- Implement only the behavior required for R3-08 - Evidence Checklist Basic.
...
* Implementation summary: Added evidence checklist schema and shared records for inspection and certification contexts with reusable document references and gap tracking.
