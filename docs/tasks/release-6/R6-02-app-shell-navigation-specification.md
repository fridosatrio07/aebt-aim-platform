...
Create and maintain the Release 6 app shell and navigation specification.
...
Documentation-only app shell/navigation control specification.
...
* Summary: Completed app shell navigation specification and updated acceptance state after implementation.
