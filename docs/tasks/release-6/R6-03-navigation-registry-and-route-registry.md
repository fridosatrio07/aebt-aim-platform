...
Create a lightweight route registry and navigation registry as the single source of truth for planned front-end navigation.
...
Add route/navigation registry files under the web components area; do not add route folders.
...
* Summary: Added route and navigation registries as the source of truth for Release 6 navigation metadata.
