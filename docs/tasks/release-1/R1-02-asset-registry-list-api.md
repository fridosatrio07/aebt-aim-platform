...
Provide tenant-scoped list API for asset registry browsing with pagination, filtering, sorting, RBAC, and audit-aware access.
...
- Added Release1DataFoundation.listAssets with tenant scope, RBAC permission, pagination, filtering, sorting, and audit event generation.
- Exposed GET /v1/data-foundation/assets through the NestJS data-foundation module.
- Added tests for tenant-scoped asset list and cross-tenant blocking.
...
- Asset list UI consumes the same shared dataset and conventions.
