...
Create an Asset 360/detail shell linking identity, hierarchy, inspection, certification, risk, documents, evidence, pending review, and audit placeholders.
...
- Added asset detail drawer/shell in the workbench with identity, hierarchy, linked documents, module status placeholders, and non-decision status display.
- Added GET /v1/data-foundation/assets/:assetId for detail retrieval.
- Kept inspection, certification, and RBI/Risk as later-release placeholders only.
...
- Asset detail shell is static/server-rendered for R1 demo data.
