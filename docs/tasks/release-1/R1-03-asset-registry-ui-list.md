...
Create the asset registry list view with saved/default views, filters, table operation, empty/loading/error/access denied states.
...
- Replaced the Release 0 placeholder shell with a Release 1 workbench including asset registry table, default/filter chips, and state indicators.
- Preserved tenant/project/site selectors and visible draft/preliminary boundary.
- Used table-first, high-volume-oriented layout.
...
- GET /v1/data-foundation/assets available for API integration.
