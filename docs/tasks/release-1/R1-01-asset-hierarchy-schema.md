...
Implement the source-backed logical asset hierarchy foundation for tenant/client/project/site/facility/system/subsystem/equipment/component/CML-TML where approved.
...
- Extended Prisma schema with Facility, AssetSystem, AssetSubsystem, Equipment, Component, CmlTmlPoint, and ThicknessReading foundation models.
- Added shared Release 1 asset hierarchy types and SPM-01 demo asset hierarchy data.
- Kept technical outputs draft/preliminary with data quality and review status fields.
...
- Database/schema task; no UI endpoint beyond shared use.
