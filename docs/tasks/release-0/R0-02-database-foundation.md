...
Prepare database foundation design and initial migration approach for PostgreSQL/TimescaleDB without implementing business schema beyond approved scope.
