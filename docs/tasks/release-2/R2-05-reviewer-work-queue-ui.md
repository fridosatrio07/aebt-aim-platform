...
Create reviewer work queue UI with priority, aging, risk level, required authority, module, site, review drawer, evidence preview, comments, and history.
...
- Added reviewer queue table with priority, authority, aging, preliminary risk level, evidence count, and linked object.
- Added review drawer with authority, aging, due state, linked object, evidence preview, and route/history actions.
- Kept review actions generic and non-final.
...
- Evidence preview uses linked document/action metadata only; evidence pack builder remains Release 3.
