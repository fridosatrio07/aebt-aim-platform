...
Create digest-oriented notification skeleton for due/overdue, missing evidence, pending review, and escalation grouping.
...
- Added notification digest and digest item models/types.
- Implemented grouped digest generation for overdue, due soon, missing evidence, pending review, and escalated items.
- No per-equipment notification flood or delivery channel integration was added.
...
- Delivery channels, thresholds, and suppression policies remain TBD.
