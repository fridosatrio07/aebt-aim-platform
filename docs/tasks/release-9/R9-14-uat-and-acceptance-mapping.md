# R9-14 - UAT and acceptance mapping
...
Map UAT-AR-001 through UAT-AR-015 to requirements, screens, permissions, audit events, and evidence.
...
* Files changed: docs/modules/asset-registry/ASSET_REGISTRY_UAT_ACCEPTANCE_MAPPING.md
* Summary: Documentation guidance completed for R9-14.
