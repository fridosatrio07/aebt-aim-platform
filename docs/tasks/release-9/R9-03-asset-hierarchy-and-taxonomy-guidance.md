# R9-03 - Asset hierarchy and taxonomy guidance
...
Define configurable hierarchy and taxonomy guidance from the MBS.
...
9-level hierarchy, mandatory/open levels, validation, inheritance, taxonomy dependency.
...
* Files changed: docs/modules/asset-registry/ASSET_HIERARCHY_AND_TAXONOMY_SPEC.md
* Summary: Documentation guidance completed for R9-03.
