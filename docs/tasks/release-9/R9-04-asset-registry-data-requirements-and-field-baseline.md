# R9-04 - Asset Registry data requirements and field baseline
...
Document logical entities, standard fields, equipment fields, versioning, source basis, and data-quality rules.
...
Data requirements guidance only, not physical schema.
...
* Files changed: docs/modules/asset-registry/ASSET_REGISTRY_DATA_REQUIREMENTS.md
* Summary: Documentation guidance completed for R9-04.
