# R9-06 - Business rules and validation rules
...
Document business and validation rules from MBS section G.
...
Batch-first, master reference, source basis, validation, warning, and approval constraints.
...
* Files changed: docs/modules/asset-registry/ASSET_REGISTRY_BUSINESS_VALIDATION_RULES.md
* Summary: Documentation guidance completed for R9-06.
