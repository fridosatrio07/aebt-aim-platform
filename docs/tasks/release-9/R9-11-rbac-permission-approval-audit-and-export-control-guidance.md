# R9-11 - RBAC, permission, approval, audit, and export-control guidance
...
Translate MBS RBAC, approval, audit, and export controls into implementation guidance.
...
Permission matrix summary, approval rules, audit catalog, export controls.
...
* Files changed: docs/modules/asset-registry/ASSET_REGISTRY_RBAC_APPROVAL_AUDIT_EXPORT_SPEC.md
* Summary: Documentation guidance completed for R9-11.
