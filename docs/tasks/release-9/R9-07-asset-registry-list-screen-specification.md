# R9-07 - Asset Registry List screen specification
...
Document Asset Registry List screen behavior and columns.
...
Dense table, toolbar, filters, row click, drawer, sidebar route discovery.
...
* Files changed: docs/modules/asset-registry/ASSET_REGISTRY_UI_SCREEN_SPEC.md
* Summary: Documentation guidance completed for R9-07.
