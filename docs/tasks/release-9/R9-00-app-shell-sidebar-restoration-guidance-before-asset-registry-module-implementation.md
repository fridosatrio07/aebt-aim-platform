# R9-00 - App shell sidebar restoration guidance before Asset Registry module implementation
...
Document the left-sidebar primary navigation rule before Asset Registry runtime work.
...
Create sidebar restoration guidance and keep future implementation aligned to existing AppSidebar/AppTopbar, route registry, and navigation registry.
...
* Files changed: docs/frontend/APP_SHELL_SIDEBAR_RESTORATION_SPEC.md
* Summary: Documentation guidance completed for R9-00.
