# R5-08 - Page Build Spec: RBI, Risk & Reviewer Queue
...
Prepare page build specifications for RBI candidate list, RBI assessment detail, risk register, and reviewer queue.
...
Plan controlled RBI workbench, assessment stepper, operating data panels, damage mechanism placeholder, PoF/CoF helper, preliminary ranking, review queue, and risk linkage.
...
Every technical output must show draft/preliminary or Needs SME Review boundary where appropriate.

## Data / Mock Data Requirements

Use consistent RBI candidate, assessment, risk register, reviewer queue, and audit trail mock objects.

## API / Backend Boundary

API-ready planning. Final RBI methodology, formulas, approval authority, interval extension, and risk acceptance are out of scope.
...
* Summary: Implemented controlled integrity dashboard, RBI candidate/assessment tables, operating data, damage mechanism, PoF/CoF helper, preliminary risk, and risk register sections.
