# R5-05 - Page Build Spec: Dashboard & My Work
...
Prepare page build specifications for Dashboard and My Work / Action Inbox.
...
Plan page sections, KPI cards, action queues, filters, saved views, drawers, role landing behavior, states, and boundaries for dashboard and action inbox.
...
Dashboard-to-action must open filtered action lists. My Work must be task-first and role-scoped.

## Data / Mock Data Requirements

Use consistent mock action items, KPI counts, notifications, audit snippets, and reviewer routing from the mock data contract.

## API / Backend Boundary

API-ready planning with static/mock interim data. Production API integration is out of scope.
...
* Summary: Implemented dashboard-to-action, page summary, My Work, reviewer queue, disabled/boundary actions, and local detail drawer sections.
